...
from .views import UserRetrieveUpdateAPIView, CurrentUserView, \
    UserUpdateAPIView, RegistrationAPIView, LoginAPIView, UserListAPIView, RequestPasswordResetEmailAPIView, \
    PasswordTokenCheckGenericAPIView, SetNewPasswordAPIView, VerifyEmail
